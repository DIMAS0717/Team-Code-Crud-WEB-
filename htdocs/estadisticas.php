...
<div class="grafico">
  ...
  <div class="barras">
    <div class="barra" style="--altura:90%; background:#666;"><span>GALLETAS OREO</span></div>
    <div class="barra" style="--altura:65%; background:#c7b185;"><span>MAZAPÁN</span></div>
    <div class="barra" style="--altura:70%; background:#8b5e3c;"><span>CHOCOLATE</span></div>
    <div class="barra" style="--altura:50%; background:#c62828;"><span>FRUTOS ROJOS</span></div>
